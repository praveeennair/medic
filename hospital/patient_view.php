  ...
  <div class="content mt-3">
    <div class="animated fadeIn">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header"> <strong class="card-title">Patient Prescription Information </strong> </div>
            <div class="card-body container" style="width:100% !important; overflow:auto !important;">
             <table id="bootstrap-data-table" class="table table-striped table-bordered text-uppercase">
                ...
                <tbody>
					 <?php
                        $uniqno=$_POST["uniqno"];
                        $result = $db->prepare("select * from pharmacyamount where uniqno='$uniqno'");
                        $result->execute();
