        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                  <form class="form-control" method="post" action="profile_update.php" autocomplete="off" enctype="multipart/form-data">
                    <div class="card">
                      ...
                      <div class="card-body card-block">	                                	
                        ...
                        <textarea class="form-control" name="accredat" readonly rows="1"><?php echo $accredat?></textarea>
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="card">
                      <div class="card-header"><strong>For Office Use Only (This information will not be shared publicly)</strong></div>
                        <div class="card-body card-block">	                                	
                            ...
                            <input type="text" id="Brand" name="npersoname" class="form-control" value="<?php echo $npersoname?>">
                            </div>
                            <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="company" class=" form-control-label">Telephone Number of the Nodal Person for this Information</label>
                            <input type="text" id="Brand" name="tnonper" class="form-control" value="<?php echo $tnonper?>">
                            </div>
                            <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="company" class=" form-control-label">Nodal Person Email Id</label>
                            <input type="text" id="Brand" name="npersonem" class="form-control" value="<?php echo $npersonem?>">
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="card">
                      <div class="card-header"><strong>Contact / Help Desk of Hospital (For Public Domain)</strong></div>
                        <div class="card-body card-block">	                                	
                            ...
                            <input type="text" id="Brand" name="emno" class="form-control" value="<?php echo $emno?>">
                            </div>
                             <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="company" class=" form-control-label">Ambulance Phone No</label>
                            <input type="text" id="Brand" name="ambno" class="form-control" value="<?php echo $ambno?>">
                            </div>
                             <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="company" class=" form-control-label">Blood Bank Phone No</label>
                            <input type="text" id="Brand" name="blbnkno" class="form-control" value="<?php echo $blbnkno?>">
                            </div>
                             <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="company" class=" form-control-label">Helpline</label>
                            <input type="text" id="Brand" name="helpno" class="form-control" value="<?php echo $helpno?>">
                            </div>
                             <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="company" class=" form-control-label">Website</label>
                            	<input type="text" id="Brand" name="website" class="form-control" value="<?php echo $website?>">
                            </div>
                             <div class="form-group col-sm-6 col-md-6 col-lg-6">
                   ...
                   <div class="card">
                      <div class="card-header"><strong>Further Details</strong></div>
                        <div class="card-body card-block">	                                	
                            ...
                            <input type="text" id="Brand" name="speciali" class="form-control" value="<?php echo $speciali?>">
                            </div>
                            <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="company" class=" form-control-label">Facilities</label>
                            <input type="text" id="Brand" name="facili" class="form-control" value="<?php echo $facili?>">
                            </div>                           
                        </div>
                    </div>                                      
