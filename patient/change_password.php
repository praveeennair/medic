        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                  <form class="form-control" method="post" action="change_password_update.php">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <label for="company" class=" form-control-label">Username</label>
                        	<input type="hidden" class="form-control" name="patid" value="<?php echo $patid;?>">    
                        ...
                        <label for="vat" class=" form-control-label">New Password</label>
                       		 <input type="password" id="Model" name="password" class="form-control">
                        </div>                   
                         <div class="form-group col-sm-6 col-md-6 col-lg-6">
