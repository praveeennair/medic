...
<?php include("include/header.php"); ?>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
               <div class="row">
				<div class="col-lg-12">
                  <form class="form-control" method="post" action="pharmacy_save.php" enctype="multipart/form-data">
                    <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="pharmacy_view.php" class="btn btn-success btn-md pull-right">
