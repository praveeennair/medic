        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                  <form class="form-control" method="post" action="laboratory_save.php" enctype="multipart/form-data" autocomplete="off">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <input type="text" id="Brand" name="licenam" class="form-control"  required pattern="[a-zA-Z1 _]{3,50}">
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        ...
                        <input type="file" id="Brand" name="file1" class="form-control" required>
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
