        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                  <form class="form-control" method="post" action="laboratory_save.php" enctype="multipart/form-data">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <input type="text" id="Brand" name="type" class="form-control" value="<?php echo $type?>" readonly>
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        <label for="company" class=" form-control-label">Address</label>
                        <input type="text" id="Brand" name="addr" class="form-control" value="<?php echo $addr?>" readonly>
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        <label for="company" class=" form-control-label">Phone Number</label>
                        <input type="text" id="Brand" name="cntno" class="form-control" value="<?php echo $cntno?>" readonly>
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        <label for="company" class=" form-control-label">Name of Superintendent Lab Technologist</label>
                        <input type="text" id="Brand" name="licenam" class="form-control" value="<?php echo $licenam?>" readonly>
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                      ...
                      <div class="card-footer">
                        <a href="laboratory_view.php" class="btn btn-success btn-md pull-right">
