  ...
  <div class="content mt-3">
    <div class="animated fadeIn">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header"> <strong class="card-title">All Pharmacy </strong> </div>
                           ...
                           if($row["stat"]=="approve")
							{
								?>
								<td>
								<a href="pharmacy_block_allow.php<?php echo '?phid='.$phid; ?>" class=" btn btn-sm btn-success">&nbsp;Allow</a>
								</td>
								<?php
							}
							else
							{
								?>
								<td>
								<a href="pharmacy_block_block.php<?php echo '?phid='.$phid; ?>" class=" btn btn-sm btn-danger">&nbsp;Block</a>
								</td>
								<?php
							}	
                            echo"</tr>";
