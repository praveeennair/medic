                           ...
                           if($row["stat"]=="approve")
							{
								?>
								<td>
								<a href="hospital_block_allow.php<?php echo '?hid='.$hid; ?>" class=" btn btn-sm btn-success">&nbsp;Allow</a>
								</td>
								<?php
							}
							else
							{
								?>
								<td>
								<a href="hospital_block_block.php<?php echo '?hid='.$hid; ?>" class=" btn btn-sm btn-danger">&nbsp;Block</a>
								</td>
								<?php
							}	
                            echo"</tr>";
