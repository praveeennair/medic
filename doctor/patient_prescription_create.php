<?php
	...
	$resultdpc = $db->prepare("select * from doctor where dcoid='$dcoid'");
	$resultdpc->execute();
	for($i=0; $rowd = $resultdpc->fetch(); $i++)
	{	
		$dname=$rowd["name"];		
	}
		$uniqno=$_POST["uniqno"];
                  ...
                  <form class="form-control" method="post" action="patient_prescription_create_save.php" autocomplete="off">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        <label for="company" class=" form-control-label">House Surgeon</label>
                        <input type="text" id="Brand" name="hname" class="form-control" value="<?php echo "House Surgeon"?>" readonly>
                        </div>
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        <label for="company" class=" form-control-label">Doctor</label>
                         <input type="text" id="Brand" name="doctor" class="form-control" value="<?php echo $dname?>" readonly>                        
                        </div>
