<?php
	...
	$resultlab = $db->prepare("select * from laboratory where labid='$labid'");
	$resultlab->execute();
	for($i=0; $rowlab = $resultlab->fetch(); $i++)
	{	
		$labname=$rowlab["name"];	
	}
?>
            ...
            <div class="card-body container" style="width:100% !important; overflow:auto !important;">
             <table id="bootstrap-data-table" class="table table-striped table-bordered text-uppercase">
               <thead>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form class="form-control" method="post" action="patient_laboratory_save.php" enctype="multipart/form-data" autocomplete="off">
                            <div class="card">
                                <div class="card-header"><strong>Bill Amount</strong></div>
                                    <div class="card-body card-block">
                                        ...
                                        <label for="company" class=" form-control-label">Laboratory Name</label>
                                             <input type="text" id="Brand" name="lname" class="form-control" value="<?php echo $labname?>" readonly>
                                        </div> 
                                    	<div class="form-group col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <label for="company" class=" form-control-label">Amount</label>
                                            <input type="number" id="Brand" name="amount" class="form-control" required min="0" step="0.01">      
                                        </div>  
